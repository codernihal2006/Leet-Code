  ...
  return (
    <div className="app-shell min-h-screen">
      <div className="admin-shell">
        <div className="mb-6">
          <h1 className="admin-heading text-4xl font-bold text-slate-900">Delete Problems</h1>
          <p className="admin-muted mt-3 text-lg text-slate-600">Review the list carefully and remove problems only when necessary.</p>
        </div>
